...
const Hero: React.FC = () => {
  return (
    // id="inicio" para que el enlace #inicio pueda saltar aquí desde el Navbar si lo deseas
    <section id="inicio" className="relative h-[90vh] w-full overflow-hidden">
      {/* Fondo con parallax */}
      <motion.div
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          style={{
            background:
              'linear-gradient(transparent 0%, transparent 45%, rgba(255,255,255,0.1) 50%, transparent 55%, transparent 100%)',
      ...
      <div className="relative z-20 h-full flex items-center justify-center text-white px-4">
        ...
        >
          ...
          >
            ...
            rubros de Edificaciones, Saneamiento e Industria.
          </motion.p>

          {/* Botón que lleva a /all-projects */}
          <motion.button
            whileHover={{
              scale: 1.05,
